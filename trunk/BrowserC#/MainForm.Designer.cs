...
namespace Browser
{
	partial class MainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnExecute.Location = new System.Drawing.Point(3, 238);
			...
			this.dataGridView1.Size = new System.Drawing.Size(791, 125);
			...
			this.imageList1.Images.SetKeyName(0, "tablerow.gif");
			this.imageList1.Images.SetKeyName(1, "ok.gif");
			this.imageList1.Images.SetKeyName(2, "wait.gif");
			this.imageList1.Images.SetKeyName(3, "warning.gif");
			// 
			// MainForm
			// 
