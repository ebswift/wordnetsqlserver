...
namespace ICSharpCode.SharpDevelop.Dom.SQL
{
	public class SQLAmbience : AbstractAmbience
	{
 ...
 */
		...
		static SQLAmbience instance;
		
		public static SQLAmbience Instance {
			get {
				if (instance == null) instance = new SQLAmbience();
				return instance;
			}
		}
